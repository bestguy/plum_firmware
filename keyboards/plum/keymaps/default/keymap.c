...
/* B3 */    GUI_T(KC_BSPC), KC_A,    KC_S,  KC_D,  KC_F,  KC_G,  KC_H,  KC_J,  KC_K,    KC_L,    KC_SCLN, KC_QUOT, KC_ENT,  KC_ENT, 
/* D0 */    KC_LSFT,        KC_Z,    KC_X,  KC_C,  KC_V,  KC_B,  KC_N,  KC_M,  KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, KC_UP,   KC_END, 
/* D1 */    KC_LCTL,        KC_LGUI, KC_LALT, SFT_T(KC_SPC), LT(2, KC_SPC),             KC_PGUP, KC_PGDN, KC_LEFT, KC_DOWN, KC_RGHT),
  ...
  KEYMAP(
    ...
    KC_TRNS, KC_A,    KC_R,    KC_S,    KC_T,    KC_D,    KC_H,    KC_N,    KC_E,    KC_I,    KC_O,    KC_QUOT, KC_TRNS, KC_TRNS, 
